      ...
      primarySlot={
        <div className="md:pr-20">
          ...
          <p className="mt-8 text-xl font-light leading-relaxed text-justify">
            ...
            in Spain. I grew up in this paradise with my family and friends. I
            loved to surf & sail Catamaran.
          </p>
        </div>
      }
      secondarySlot={
    ...
    <SplitSection
      ...
      primarySlot={
        <div className="">
          ...
          <p className="mt-8 text-xl font-light leading-relaxed text-justify">
            My first job was a DJ was in Spain and I still work as one here in
            Malmö, Sweden. In Spain I have had many DJ gigs, but the best place
            I have worked in was in <a href="https://www.pacha.com">Pacha</a>.
            In Malmö I have worked in many clubs. Atm I get all my Dj Gigs from
            my site <a href="https://www.djszmak.se">djszmak.se</a>.
          </p>
        </div>
      }
      secondarySlot={
    ...
    <SplitSection
      primarySlot={
        <div className="md:pr-20">
          ...
          <p className="mt-8 text-xl font-light leading-relaxed text-justify">
            I live in Malmö togather with my family. In my free time I like to
            produce music, code new fun projects & play computer games.
          </p>
        </div>
      }
      secondarySlot={
