          ...
          <div className="flex-1 md:px-3">
            <Card className="mb-8">
              ...
              <div className="flex items-center mt-8">
                <img
                  className="w-12 h-12 mr-4 rounded-full"
                  src="https://media-exp1.licdn.com/dms/image/C4D03AQG2euUqAU9oIw/profile-displayphoto-shrink_100_100/0/1516977325292?e=1668038400&v=beta&t=zJBe3tJwy6rZ3D0QwRGDGrR4vmS-3VUiEi8-9RrCHFM"
                  alt="Testimonial Guts&Glory"
                />
                <div>
          ...
          <div className="flex-1 md:px-3">
            <Card className="mb-8 ">
              ...
              <div className="flex items-center mt-8">
                <img
                  className="w-12 h-12 mr-4 rounded-full"
                  src="https://media-exp1.licdn.com/dms/image/C4E03AQGq9Hc2dhvihw/profile-displayphoto-shrink_100_100/0/1653467985743?e=1668038400&v=beta&t=1XpRKB1PtpdGwUVUmfrrKofJM6s-Hn0SnmhhyDeYPUo"
